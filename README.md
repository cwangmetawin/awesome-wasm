...
- [TiDB playground - writing SQL in an in-browser golang database in WebAssembly](https://play.tidb.io/)
...
- [Old Games - classic games free in the browser via WebAssembly, play with friends](https://old-games.xyz)
